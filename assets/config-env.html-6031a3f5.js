import{_ as e}from"./plugin-vue_export-helper-c27b6911.js";import{r as o,o as p,c as t,b as n,d as s,f as l,a as i}from"./app-90f462c1.js";const c={},r=n("h1",{id:"环境-env、全局变量-globals",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#环境-env、全局变量-globals","aria-hidden":"true"},"#"),s(" 环境 env、全局变量 globals")],-1),u={href:"https://eslint.org/docs/user-guide/configuring/language-options",target:"_blank",rel:"noopener noreferrer"},d=i(`<p>环境 env 提供预定义的全局变量。要在配置文件中指定环境，请使用 <code>env</code> 键并通过将每个环境设置为 <code>true</code> 来指定要启用的环境。</p><p>首先看一个例子</p><p>.eslintrc</p><div class="language-json line-numbers-mode" data-ext="json"><pre class="language-json"><code><span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
  ...
  <span class="token comment">// ...</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>就可以正常校验文件。</p>`,27);function v(k,m){const a=o("ExternalLinkIcon");return p(),t("div",null,[r,n("p",null,[n("a",u,[s("官网说明"),l(a)])]),d])}const q=e(c,[["render",v],["__file","config-env.html.vue"]]);export{q as default};
