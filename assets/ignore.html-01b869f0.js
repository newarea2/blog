import{_ as t}from"./plugin-vue_export-helper-c27b6911.js";import{r as l,o as c,c as o,b as n,d as a,f as e,a as i}from"./app-90f462c1.js";const p={},d={href:"https://eslint.org/docs/user-guide/configuring/ignoring-code#the-eslintignore-file",target:"_blank",rel:"noopener noreferrer"},r=i(`<p>隐式的忽略规则：</p><ul><li><code>node_modules/</code> 将被忽略</li><li>点文件（<code>.eslintrc.*</code>除外）以及点文件夹和其内容将被忽略</li></ul><p>Eslint 中的“主动”忽略校验方式有 3 种：</p><ul><li>文件中使用注释取消校验</li><li>使用忽略文件 <code>.eslintignore</code></li><li>使用命令行参数 <code>--ignore-pattern</code></li></ul><p>.eslintignore</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>!.build
.build/*
!.build/test.js
