import{_ as e}from"./plugin-vue_export-helper-c27b6911.js";import{r as o,o as p,c as t,a as n,b as s,f as l,d as i}from"./app-72775176.js";const c={},r=n("h1",{id:"环境-env、全局变量-globals",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#环境-env、全局变量-globals","aria-hidden":"true"},"#"),s(" 环境 env、全局变量 globals")],-1),u={href:"https://eslint.org/docs/user-guide/configuring/language-options",target:"_blank",rel:"noopener noreferrer"},d=i(`<p>环境 env 提供预定义的全局变量。要在配置文件中指定环境，请使用 <code>env</code> 键并通过将每个环境设置为 <code>true</code> 来指定要启用的环境。</p><p>首先看一个例子</p><p>.eslintrc</p><div class="language-json line-numbers-mode" data-ext="json"><pre class="language-json"><code><span class="token punctuation">{</span>
