import{_ as n}from"./plugin-vue_export-helper-c27b6911.js";import{o as s,c as a,d as e}from"./app-72775176.js";const p={},t=e(`<h1 id="与-rollup-对比" tabindex="-1"><a class="header-anchor" href="#与-rollup-对比" aria-hidden="true">#</a> 与 Rollup 对比</h1><ul><li>创建一个 npm 项目 espree-test</li><li>安装 espree <code>npm i espree</code></li></ul><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>|-- espree-test
    |-- package-lock.json
    |-- package.json
    |-- rollup.config.js
    |-- src
