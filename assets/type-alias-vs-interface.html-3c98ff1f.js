import{_ as e}from"./plugin-vue_export-helper-c27b6911.js";import{r as p,o as t,c as i,b as n,d as s,f as l,a as c}from"./app-90f462c1.js";const o={},r=n("h1",{id:"类型别名vs接口",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#类型别名vs接口","aria-hidden":"true"},"#"),s(" 类型别名VS接口")],-1),d={href:"https://www.typescriptlang.org/docs/handbook/2/everyday-types.html#differences-between-type-aliases-and-interfaces",target:"_blank",rel:"noopener noreferrer"},u=c(`<div class="language-typescript line-numbers-mode" data-ext="ts"><pre class="language-typescript"><code><span class="token comment">// 类型别名</span>
...
<span class="token keyword">interface</span> <span class="token class-name">Girl</span> <span class="token punctuation">{</span>
  ...
  age<span class="token operator">:</span> <span class="token builtin">number</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>书写上的区别：</p><ul><li>类型别名通过<code>type</code>关键字定义，而接口通过<code>interface</code>定义;</li><li>类型别名后面需要跟上<code>=</code>，而接口不需要;</li><li>类型别名中使用的是<code>,</code>，而接口是<code>;</code></li></ul><p>关键区别在于，与始终可扩展的接口相比，类型别名无法重新打开以添加​​新属性。</p><h2 id="_1-接口" tabindex="-1"><a class="header-anchor" href="#_1-接口" aria-hidden="true">#</a> 1 接口</h2><h3 id="_1-1-新增属性" tabindex="-1"><a class="header-anchor" href="#_1-1-新增属性" aria-hidden="true">#</a> 1.1 新增属性</h3><p>新建一个新接口继承已有接口</p><div class="language-typescript line-numbers-mode" data-ext="ts"><pre class="language-typescript"><code><span class="token keyword">interface</span> <span class="token class-name">Animal</span> <span class="token punctuation">{</span>
