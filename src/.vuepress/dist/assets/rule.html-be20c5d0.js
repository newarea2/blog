import{_ as s}from"./plugin-vue_export-helper-c27b6911.js";import{r as l,o as a,c as d,a as n,b as e,f as r,d as c}from"./app-f1b20077.js";const v={},t=n("h1",{id:"常用规则",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#常用规则","aria-hidden":"true"},"#"),e(" 常用规则")],-1),o={id:"_1-eslint-官方提供了3种预安装包",tabindex:"-1"},u=n("a",{class:"header-anchor",href:"#_1-eslint-官方提供了3种预安装包","aria-hidden":"true"},"#",-1),m={href:"https://eslint.org/blog/2015/11/eslint-v1.10.0-released#improvements-to---init",target:"_blank",rel:"noopener noreferrer"},b=c(`<h3 id="_1-1-eslint-config-google" tabindex="-1"><a class="header-anchor" href="#_1-1-eslint-config-google" aria-hidden="true">#</a> 1.1 eslint-config-google</h3><p>Google标准</p><p>执行安装：</p><p>npm install eslint eslint-config-google -g</p><h3 id="_1-2-eslint-config-airbnb" tabindex="-1"><a class="header-anchor" href="#_1-2-eslint-config-airbnb" aria-hidden="true">#</a> 1.2 eslint-config-airbnb</h3><p>Airbnb标准,它依赖eslint, eslint-plugin-import, eslint-plugin-react, and eslint-plugin-jsx-a11y等插件，并且对各个插件的版本有所要求。</p><p>你可以执行以下命令查看所依赖的各个版本：</p><p>npm info &quot;eslint-config-airbnb@latest&quot; peerDependencies<br> 你会看到以下输出信息，包含每个了每个plugins的版本要求</p><p>{ eslint: &#39;^3.15.0&#39;,<br> &#39;eslint-plugin-jsx-a11y&#39;: &#39;^3.0.2 || ^4.0.0&#39;,<br> &#39;eslint-plugin-import&#39;: &#39;^2.2.0&#39;,<br> &#39;eslint-plugin-react&#39;: &#39;^6.9.0&#39; }<br> 知道了每个plugins的版本要求后，代入以下命令执行安装即可使用：</p><p>npm install eslint-config-airbnb eslint@^#.#.# eslint-plugin-jsx-a11y@^#.#.# eslint-plugin-import@^#.#.# eslint-plugin-react@^#.#.# -g</p><h3 id="_1-3-eslint-config-standard" tabindex="-1"><a class="header-anchor" href="#_1-3-eslint-config-standard" aria-hidden="true">#</a> 1.3 eslint-config-standard</h3><p>Standard标准，它是一些前端工程师自定的标准。</p><p>执行安装：</p><p>npm install eslint-config-standard eslint-plugin-standard eslint-plugin-promise -g</p><h2 id="_2-常用规则" tabindex="-1"><a class="header-anchor" href="#_2-常用规则" aria-hidden="true">#</a> 2 常用规则</h2><p>与 JavaScript 代码中可能的错误或逻辑错误有关的规则：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>no-cond-assign           // 禁止条件表达式中出现模棱两可的赋值操作符 
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>下面这些规则是关于最佳实践的，帮助你避免一些问题：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>array-callback-return   // 强制数组方法的回调函数中有 return 语句 
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>与使用严格模式和严格模式指令有关规则：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>strict  // 要求或禁止使用严格模式指令 
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>与变量声明有关规则：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>init-declarations     // 要求或禁止 var 声明中的初始化 
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>关于Node.js 或 在浏览器中使用CommonJS 的规则：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>global-require        // 要求 require() 出现在顶层模块作用域中 
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>下面的规则是关于风格指南的，而且是非常主观的</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>array-bracket-spacing          // 强制数组方括号中使用一致的空格 
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,27);function p(g,f){const i=l("ExternalLinkIcon");return a(),d("div",null,[t,n("h2",o,[u,e(" 1 eslint "),n("a",m,[e("官方"),r(i)]),e("提供了3种预安装包：")]),b])}const _=s(v,[["render",p],["__file","rule.html.vue"]]);export{_ as default};
