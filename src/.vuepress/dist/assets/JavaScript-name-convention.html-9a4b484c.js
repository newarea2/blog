 ...
 * @关键字
 **/</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,26),i=[l];function c(d,p){return s(),a("div",null,i)}const u=n(t,[["render",c],["__file","JavaScript-name-convention.html.vue"]]);export{u as default};
