import{_ as e}from"./plugin-vue_export-helper-c27b6911.js";import{r as p,o as t,c as i,a as n,b as s,f as l,d as c}from"./app-f1b20077.js";const o={},r=n("h1",{id:"类型别名vs接口",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#类型别名vs接口","aria-hidden":"true"},"#"),s(" 类型别名VS接口")],-1),d={href:"https://www.typescriptlang.org/docs/handbook/2/everyday-types.html#differences-between-type-aliases-and-interfaces",target:"_blank",rel:"noopener noreferrer"},u=c(`<div class="language-typescript line-numbers-mode" data-ext="ts"><pre class="language-typescript"><code><span class="token comment">// 类型别名</span>
