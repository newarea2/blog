import{_ as e}from"./plugin-vue_export-helper-c27b6911.js";import{r as p,o as t,c as o,b as n,d as s,f as l,a as i}from"./app-90f462c1.js";const c={},r=n("h1",{id:"整合-typescript",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#整合-typescript","aria-hidden":"true"},"#"),s(" 整合 TypeScript")],-1),u={href:"https://github.com/rollup/plugins/tree/master/packages/node-resolve",target:"_blank",rel:"noopener noreferrer"},d=i(`<ul><li>新建 npm 项目 rollup-with-eslint</li><li>安装依赖 <code>npm i rollup-plugin-typescript2 typescript tslib --D</code></li></ul><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>|-- rollup-with-eslint
    |-- tsconfig.json
    |-- package-lock.json
    |-- package.json
    |-- rollup.config.js
