...
![image-20201230111207968](/images/20230525/02.jpg)
...
![Kapture 2020-12-10 at 16.13.53.gif](/images/20230525/04.gif)
...
![image.png](/images/20230525/05.png)
...
提供创建一切数据变化都是可以被监听的响应式对象的方法。![Kapture 2020-12-10 at 11.47.59.gif](/images/20230525/06.gif)

### 2\. 编译模块

![image.png](/images/20230525/07.png)
...
渲染函数通过以下三个周期将视图渲染到页面上![image.png](/images/20230525/08.png)
...
![render-proxy](/images/20230525/10.gif)
...
![image-20200713122621925](/images/20230525/11.jpg)
...
![image.png](/images/20230525/12.png)

HTML在浏览器中会映射为一些列节点，方便我们去调用。

![image.png](/images/20230525/13.png)
...
![image.png](/images/20230525/14.png)

### 3\. 什么是渲染函数

在Vue中我们通过将视图模板(template)编译为渲染函数(render function)再转化为虚拟Dom

![image.png](/images/20230525/15.png)

### 4\. 通过DomDiff高效更新视图

![image.png](/images/20230525/16.png)

### 5\. 总结

举个栗子🌰 虚拟Dom和Dom就像大楼和大楼设计图之间的关系。

![image.png](/images/20230525/17.png)
...
![image-20201230104838657](/images/20230525/19.png)
...
![Snip20200713_17](/images/20230525/21.jpg)
...
![image-20200713150630150](/images/20230525/22.jpg)
...
-   compile-core 核心编译逻辑
    ...
    -   基础类型解析 v-for 、v-on
        ...
        ![image-20200713183256931](/images/20230525/23.jpg)
...
-   compile-dom 针对浏览器的编译逻辑
    ...
    -   v-clock
        ...
        ![image-20200713183210079](/images/20230525/24.jpg)
