import{_ as s}from"./plugin-vue_export-helper-c27b6911.js";import{o as n,c as a,a as e}from"./app-90f462c1.js";const t={},p=e(`<h1 id="note" tabindex="-1"><a class="header-anchor" href="#note" aria-hidden="true">#</a> note</h1><h2 id="_1-store-目录结构及内容" tabindex="-1"><a class="header-anchor" href="#_1-store-目录结构及内容" aria-hidden="true">#</a> 1 store 目录结构及内容</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>|-- store
    |-- index.ts
    |-- modules
        |-- user
            |-- index.ts
