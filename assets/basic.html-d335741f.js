import{_ as a}from"./plugin-vue_export-helper-c27b6911.js";import{r as t,o,c as l,b as n,d as s,f as i,a as c}from"./app-90f462c1.js";const p={},r=n("h1",{id:"helloworld",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#helloworld","aria-hidden":"true"},"#"),s(" helloWorld")],-1),d={href:"https://eslint.org/docs/user-guide/getting-started",target:"_blank",rel:"noopener noreferrer"},u=c(`<ul><li>创建一个 npm 项目</li><li>生成一个 ESLint 模板配置文件 <code>npx eslint --init</code></li></ul><p>最终项目的目录结构如下。</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>|-- eslint-test
    |-- .eslintrc
    |-- package-lock.json
    |-- package.json
    |-- src
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>进入 eslint-test 目录，执行 <code>npx eslint ./src/index.js</code> （注意，要指定一个目标文件）或者执行 <code>npx eslint --ext .js,.jsx,.ts,.tsx</code>。</p><p>在配置文件 <code>rules</code> 属性中可以自定义规则：</p><ul><li><code>off</code> 或 0 表示关闭该规则。</li><li><code>warn</code> 或 1 表示将该规则作为一个警告打开。</li><li><code>error</code> 或 2 表示将该规则作为一个错误打开。</li></ul>`,8);function v(k,m){const e=t("ExternalLinkIcon");return o(),l("div",null,[r,n("p",null,[n("a",d,[s("Getting Started with ESLint"),i(e)])]),u])}const x=a(p,[["render",v],["__file","basic.html.vue"]]);export{x as default};
