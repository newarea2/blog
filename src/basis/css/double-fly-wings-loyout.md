...
![图1](/images/20230725/shaungfeiyi01.png)
![图2](/images/20230725/shuangfeiyi02.png)

1 `.flbox2 margin-left:-500px;`，则`.flbox2`会向左偏移500px（以.flbox1的右边框为起点），之后`.flbox3`会紧贴`.flbox1`排列。如图：

![图3](/images/20230725/shuangfeiyi03.png)
![图4](/images/20230725/shuangfeiyi04.png)

2 同理，设置`.flbox3 margin-left:-100px;`，则其现在偏移（以`.flbox1`的右边框为起点），覆盖了`.flbox1`。

![图5](/images/20230725/shuangfeiyi05.png)
![图6](/images/20230725/shuangfeiyi06.png)
...
![图7](/images/20230725/shuangfeiyi07.png)
![图8](/images/20230725/shuangfeiyi08.png)
