import{_ as n}from"./plugin-vue_export-helper-c27b6911.js";import{o as s,c as a,d as e}from"./app-f1b20077.js";const t={},p=e(`<h1 id="利用-github-actions-构建-github-pages-所需源文件" tabindex="-1"><a class="header-anchor" href="#利用-github-actions-构建-github-pages-所需源文件" aria-hidden="true">#</a> 利用 GitHub Actions 构建 GitHub Pages 所需源文件</h1><p>1.新建一个 Vue3 + Vite 项目 vite-project ，并初始化为一个 Git 项目</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">pnpm</span> create vite
