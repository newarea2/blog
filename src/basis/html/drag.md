...
<body>
  ...
  <script>
    ...
    d1.ondragstart = function (ev) {
      ...
      ev.dataTransfer.setData('url1','./images/error.png');
    }
    d1.ondrag = function () {
      console.log('drag')
    }
...
![02](/images/20230729/02.png)

![03](/images/20230729/03.png)
...
```html
<img src="./images/error.png" class="d1">
<br>
<input>
