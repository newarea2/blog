import{_ as t}from"./plugin-vue_export-helper-c27b6911.js";import{r as p,o as e,c,a as n,b as s,f as i,d as o}from"./app-72775176.js";const l={},u=n("h1",{id:"修改滚动条样式",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#修改滚动条样式","aria-hidden":"true"},"#"),s(" 修改滚动条样式")],-1),r={href:"https://www.cnblogs.com/lfhy/p/6796653.html",target:"_blank",rel:"noopener noreferrer"},d=o(`<p>滚动条的css样式主要由下面四个伪元素组成：</p><ul><li>::-webkit-scrollbar 定义了滚动条整体的样式；</li><li>::-webkit-scrollbar-track 轨道部分；</li><li>::-webkit-scrollbar-thumb 滑块部分；</li><li>::-webkit-scrollbar-button 两端按钮；</li></ul><figure><img src="https://blog-1320825986.cos.ap-nanjing.myqcloud.com/20230725/06.png" alt="06" tabindex="0" loading="lazy"><figcaption>06</figcaption></figure><p>例子1：</p><div class="language-css line-numbers-mode" data-ext="css"><pre class="language-css"><code><span class="token comment">/*---滚动条大小--*/</span>
