import{_ as o}from"./plugin-vue_export-helper-c27b6911.js";import{r as l,o as i,c as p,a as n,b as a,f as e,d as t}from"./app-72775176.js";const c={},r=t(`<h1 id="baseurl、paths" tabindex="-1"><a class="header-anchor" href="#baseurl、paths" aria-hidden="true">#</a> baseUrl、paths</h1><h2 id="baseurl" tabindex="-1"><a class="header-anchor" href="#baseurl" aria-hidden="true">#</a> baseUrl</h2><p>用于设置解析非相对模块名称的基本目录，相对模块不会受到baseUrl的影响。下面通过示例来说明</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>|-- ts-demo
    |-- .gitignore
    |-- ex.ts
    |-- package.json
    |-- pnpm-lock.yaml
