import{_ as t}from"./plugin-vue_export-helper-c27b6911.js";import{r as o,o as p,c as i,b as n,d as s,f as e,a as l}from"./app-90f462c1.js";const c={},r=n("h1",{id:"paths",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#paths","aria-hidden":"true"},"#"),s(" paths")],-1),d={href:"https://www.typescriptlang.org/tsconfig#paths",target:"_blank",rel:"noopener noreferrer"},u={href:"https://www.typescriptlang.org/docs/handbook/module-resolution.html#path-mapping",target:"_blank",rel:"noopener noreferrer"},v=l(`<p>用于设置模块名到基于 baseUrl 的路径映射</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>|-- ts-demo
    |-- .gitignore
    |-- ex.ts
    |-- package.json
    |-- pnpm-lock.yaml
